...
def main():
    ...
    #NEW
    choicePairs = list()
    buttonSetup = [(310, 350, 'red'), (310, 310, 'yellow'), (310, 270, 'blue'), (310, 135, 'green'), (310, 95, 'cyan')]
    ...
    sun = makeColoredRect(Point(150, 400), 90, 90, 'yellow', win)
    roof = Polygon(Point(50, 200), Point(250, 200), Point(150, 300))
    roof.setFill('black')
    roof.draw(win)
    
    #NEW
    shapePairs = [(house, 'house'), (door, 'door'), (roof, 'roof'), (sun, 'sun')] 
